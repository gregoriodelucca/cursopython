...
class Calculator:
        ...
        for row_values in buttons:
            for button in row_values:
                ...
                if button_text == 'C':
                    ...
                    button.config(bg='#e74c3c', fg='#fff' )
                ...
                if button_text == '=':
                    ...
                    button.config(bg='#34495e', fg='#fff' )
    ...
    def _fix_text(self, text):
        ...
        #substitui operadores aritmeticos apenas um sinal
    ...
    def calculate(self , event=None):
        ...
        try:
            ...
            self.label.config(text='essa conta nao foi possivel de fazer!')
